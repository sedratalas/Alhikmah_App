...
void main() async{
  ...
  // Stripe.publishableKey = "pk_test_51Rvc2bRwG40DXaG9MmohL9uczW6iQl61wuUp4kWR0WKpc3PR3t2IBSfz7xVzbBNoEaty8z3CnNE5UeFYKWHiX0B400gXUnzelU";
...
print(accessToken);
  ...
  if (accessToken != null) {
    ...
    initialScreen = SignupStep1Screen();
  }
