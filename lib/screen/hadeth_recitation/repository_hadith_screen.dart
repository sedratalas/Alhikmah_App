...
import 'package:alhekmah_app/core/app_service.dart';
...
class _HadethRecitationScreenState extends State<HadethRecitationScreen> {
  ...
  Future<void> _startRecording() async {
    ...
    if (hasPermission) {
      ...
      setState(() {
        _isRecording = true;
        _hasRecording = false; // إعادة تعيين الحالة عند بدء تسجيل جديد
        _isPlayingRecorded = false; // إعادة تعيين حالة التشغيل
        _transcription = null;
        _matchScore = null;
  ...
  Future<void> _stopRecording(String targetHadithMatn) async {
    ...
    setState(() {
      ...
      _hasRecording = true; // تعيين هذا المتغير إلى true بعد التوقف
    });
    ...
    if (_audioFilePath != null) {
      final result = await AppServices.hadithRepository.processHadithAudio(
        ...
        targetHadithMatn: targetHadithMatn,
      );
      ...
      if (result.error != null) {
        ...
        setState(() {
          _transcription = result.data!['transcription'];
            ...
            child: Scaffold(
              ...
              body: Stack(
                children: [
                  ...
                  // ------------------------------------
                  if (_hasRecording && !_isRecording && !_isProcessingTranscription)
                    Positioned(
                      bottom: 50,
                      left: 0,
                      right: 0,
...
// import 'package:alhekmah_app/core/utils/asset_manager.dart';
// import 'package:alhekmah_app/core/utils/color_manager.dart';
// import 'package:alhekmah_app/core/app_service.dart'; // Import the new AppServices
// import 'package:alhekmah_app/model/standard_hadith_model.dart';
// import 'package:alhekmah_app/screen/hadeth_recitation/bloc/hadith_bloc.dart';
// import 'package:alhekmah_app/screen/hadeth_recitation/bloc/hadith_state.dart';
// import 'package:audioplayers/audioplayers.dart';
